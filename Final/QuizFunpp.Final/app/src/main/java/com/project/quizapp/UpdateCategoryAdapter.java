...
public class UpdateCategoryAdapter extends RecyclerView.Adapter<UpdateCategoryAdapter.ViewHolder> {
    ...
    private List<UpdateCategoryModel> cat_list;

    public UpdateCategoryAdapter(List<UpdateCategoryModel> cat_list) {
        this.cat_list = cat_list;
    }

    @NonNull
    @Override
    public UpdateCategoryAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.update_cat_item_layout,viewGroup,false);

        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull UpdateCategoryAdapter.ViewHolder viewHolder, int pos) {
        //getting the name and through position passing
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        //setting up the data to the question once edited
        private void setData(String title, final int pos, final UpdateCategoryAdapter adapter)
        {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    UpdateActivity.selected_cat_index = pos;
                    Intent intent = new Intent(itemView.getContext(),UpdateSetsActivity.class);
        ...
        private void deleteCategory(final int id, final Context context, final UpdateCategoryAdapter adapter)
        {
            loadingDialog.show();
            ...
            firestore.collection("QUIZ").document("Category")
                    ...
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void aVoid) {
                            ...
                            UpdateActivity.catList.remove(id);
        ...
        private void updateCategory(final String catNewName, final int pos, final Context context, final UpdateCategoryAdapter adapter)
        {
            editDialog.dismiss();
                            ...
                            firestore.collection("QUIZ").document("Category")
                                    ...
                                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                                        ...
                                        public void onSuccess(Void aVoid) {
                                            ...
                                            UpdateActivity.catList.get(pos).setName(catNewName);
                                            adapter.notifyDataSetChanged();
                                            loadingDialog.dismiss();
