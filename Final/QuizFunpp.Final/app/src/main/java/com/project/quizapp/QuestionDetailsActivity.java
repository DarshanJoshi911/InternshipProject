...
public class QuestionDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //setting a loading dialogue box
        ...
        //firestore instance to get the data
        ...
        //Checking if the questions are set or not
        addQB.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //getting all the values from the EditText and checking for null values
    ...
    //adding questins to the firestore
    private void addNewQuestion()
    {
        ...
        //sending data to firestore instance
        ...
        firestore.collection("QUIZ").document(catList.get(selected_cat_index).getId())
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        //firestore will have a connections
                        firestore.collection("QUIZ").document(catList.get(selected_cat_index).getId())
                ...
                .addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        //onfailure, Failure message is provided
                        Toast.makeText(QuestionDetailsActivity.this,e.getMessage(),Toast.LENGTH_SHORT).show();
                        loadingDialog.dismiss();
                    }
                });
    ...
    {
        //loading data from the list using model
    ...
    {
        //Getting the question and updating quesion to the firestore
        loadingDialog.show();
