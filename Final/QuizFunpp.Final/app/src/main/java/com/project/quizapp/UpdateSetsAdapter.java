...
class UpdateSetAdapter extends RecyclerView.Adapter<UpdateSetAdapter.ViewHolder> {

    private List<String> setIDs;

    public UpdateSetAdapter(List<String> setIDs) {
        this.setIDs = setIDs;
    }

    //adapter to update sets
    @NonNull
    @Override
    public UpdateSetAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.update_cat_item_layout,viewGroup,false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull UpdateSetAdapter.ViewHolder viewHolder, int i) {
        //getting the ID of the set
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        //method to set the data to the set

        private void setData(final int pos, final String setID, final UpdateSetAdapter adapter)
        {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(itemView.getContext(),UpdateQuestionsActivity.class);
        ...
        private void deleteSet(final int pos, String setID, final Context context, final UpdateSetAdapter adapter)
        {
            loadingDialog.show();
                                    ...
                                    firestore.collection("QUIZ").document(catList.get(selected_cat_index).getId())
                                            ...
                                            .addOnSuccessListener(new OnSuccessListener<Void>() {
                                                ...
                                                public void onSuccess(Void aVoid) {
                                                    ...
                                                    UpdateSetsActivity.setsIDs.remove(pos);

                                                    catList.get(selected_cat_index).setNoOfSets(String.valueOf(UpdateSetsActivity.setsIDs.size()));
