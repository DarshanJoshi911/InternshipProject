...
import static com.project.quizapp.UpdateQuestionsActivity.quesList;


public class UpdateQuestionsAdapter extends RecyclerView.Adapter<UpdateQuestionsAdapter.ViewHolder> {

    private List<UpdateQuestionsModel> ques_list;

    public UpdateQuestionsAdapter(List<UpdateQuestionsModel> ques_list) {
        this.ques_list = ques_list;
    }

    @NonNull
    @Override
    public UpdateQuestionsAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull UpdateQuestionsAdapter.ViewHolder viewHolder, int pos) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private void setData(final int pos, final UpdateQuestionsAdapter adapter)
        {
        ...
        private void deleteQuestion(final int pos, final Context context, final UpdateQuestionsAdapter adapter)
        {
            loadingDialog.show();
