...
public class UpdateSetsActivity extends AppCompatActivity {

    //variables
    private RecyclerView setsView;
    private Button addSetB;
    private UpdateSetAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_sets);
        ...
        loadingDialog = new Dialog(UpdateSetsActivity.this);
        ...
        addSetB.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //calling method on click to add a new set
                addNewSet();
            }
        });

        firestore = FirebaseFirestore.getInstance();
        //Setting the Layout of the file
            ...
            public void onSuccess(DocumentSnapshot documentSnapshot) {
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(UpdateSetsActivity.this,e.getMessage(),Toast.LENGTH_SHORT).show();
                        loadingDialog.dismiss();
                    }
                });
                        ...
                        firestore.collection("QUIZ").document(curr_cat_id)
                                ...
                                .addOnSuccessListener(new OnSuccessListener<Void>() {
                                    ...
                                    public void onSuccess(Void aVoid) {
                                        ...
                                        Toast.makeText(UpdateSetsActivity.this, " Set Added Successfully",Toast.LENGTH_SHORT).show();
