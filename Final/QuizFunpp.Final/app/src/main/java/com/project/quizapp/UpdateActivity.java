...
public class UpdateActivity extends AppCompatActivity {
    ...
    public static List<UpdateCategoryModel> catList = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loadingDialog = new Dialog(UpdateActivity.this);
        loadingDialog.setContentView(R.layout.loading_progressbar);
        loadingDialog.setCancelable(false);
        loadingDialog.getWindow().setBackgroundDrawableResource(R.drawable.progress_background);
        loadingDialog.getWindow().setLayout(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);

        addCatDialog = new Dialog(UpdateActivity.this);
                ...
                if(task.isSuccessful())
                {
                    ...
                    if(doc.exists())
                    {
                        ...
                        for(int i=1; i <= count; i++)
                        {
                            ...
                            catList.add(new UpdateCategoryModel(catid,catName,"0","1"));
                        }

                        adapter = new UpdateCategoryAdapter(catList);
                        cat_recycler_view.setAdapter(adapter);

                    }
                    else
                    {
                        Toast.makeText(UpdateActivity.this,"No Category Document Exists!",Toast.LENGTH_SHORT).show();
                        finish();
                    }
                        ...
                        firestore.collection("QUIZ").document("Category")
                                ...
                                .addOnSuccessListener(new OnSuccessListener<Void>() {
                                    ...
                                    public void onSuccess(Void aVoid) {
                                        ...
                                        Toast.makeText(UpdateActivity.this,"Category added successfully",Toast.LENGTH_SHORT).show();

                                        catList.add(new UpdateCategoryModel(doc_id,title,"0","1"));
